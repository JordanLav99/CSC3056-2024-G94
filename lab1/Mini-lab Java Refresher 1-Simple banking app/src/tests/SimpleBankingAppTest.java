...
public class SimpleBankingAppTest {
	...
	public static void testWithdrawals() {
	    ...
	    if (balanceBefore - withdrawalAmount == balanceAfter)
	        ...
	        System.out.println(TestUtils.TEXT_COLOR_RED + "testWithdrawals: TC1 FAILED: balanceBefore - withdrawalAmount != balanceAfter" + TestUtils.TEXT_COLOR_RESET);
